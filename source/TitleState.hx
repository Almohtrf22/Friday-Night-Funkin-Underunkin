...

{
...

	{
		...
		loadingImage = new FlxSprite(0,0).loadGraphic(Paths.image('loadingdemo','underfunkin'));

		loadingDone = new FlxSprite(0,0).loadGraphic(Paths.image('loadingunderfunkin','underfunkin'));
  ...
  var loadingImage:FlxSprite;
...

	{
...

		{
			...
			var snd:FlxSound = new FlxSound().loadEmbedded(Paths.sound('eyes','underfunkin'));
